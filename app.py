...
def render_monitoring_tab(mode):
    ...
    with col2:
        ...
        alerts = [
            ...
            {"level": "High", "type": "Нет проверки подлинности", "cashier": "Касса №2", "time": "12:44:05"},
            {"level": "Medium", "type": "Подозрительная активность", "cashier": "Касса №1", "time": "12:40:30"},
            {"level": "Critical", "type": "Отмена чека без менеджера", "cashier": "Касса №4", "time": "12:38:15"},
        ]
...
def render_incidents_tab():
    ...
    data = {
        ...
        "Тип нарушения": [
            ...
            "Отмена чека", "Лишний товар", "Недосдача", "Ошибка сканирования",
            "Выдача до проверки", "Нет проверки подлинности", "Подозрительная активность"
        ],
